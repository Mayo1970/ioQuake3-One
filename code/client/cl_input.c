...
void CL_JoystickMove( usercmd_t *cmd ) {
...
#ifdef IOQ3_UWP
	float jSensScale = cl_sensitivity->value / 5.0f;
#else
	float jSensScale = 1.0f;
#endif
	float yaw     = j_yaw->value     * cl.joystickAxis[j_yaw_axis->integer] * jSensScale;
	...
	float pitch   = j_pitch->value   * cl.joystickAxis[j_pitch_axis->integer] * jSensScale;

...
#ifdef IOQ3_UWP
	// Must appear before generic JOY* so Key_StringToKeynum("A") → K_JOY1, not ASCII 97.
	{"A",        K_JOY1  },  // SDL button 0
	{"B",        K_JOY2  },  // SDL button 1
	{"X",        K_JOY3  },  // SDL button 2
	{"Y",        K_JOY4  },  // SDL button 3
	{"VIEW",     K_JOY5  },  // SDL button 4 (BACK)
	{"GUIDE",    K_JOY6  },  // SDL button 5
	{"MENU_BTN", K_JOY7  },  // SDL button 6 (START)
	{"L3",       K_JOY8  },  // SDL button 7
	{"R3",       K_JOY9  },  // SDL button 8
	{"LB",       K_JOY10 },  // SDL button 9
	{"RB",       K_JOY11 },  // SDL button 10
	{"D-pad Up",   K_JOY12 },  // SDL button 11
	{"D-pad Down", K_JOY13 },  // SDL button 12
	{"D-pad Left", K_JOY14 },  // SDL button 13
	{"D-pad Right",K_JOY15 },  // SDL button 14
	{"LT",       K_JOY16 },  // axis 4 (shadowed below)
	{"RT",       K_JOY17 },  // axis 5 (shadowed below)
#endif
	{"JOY1", K_JOY1},
	{"JOY2", K_JOY2},
	{"JOY3", K_JOY3},
...
#ifdef IOQ3_UWP
	if ( key == K_JOY2 && !( clc.state == CA_ACTIVE && Key_GetCatcher() == 0 ) ) {
		key = K_ESCAPE;
		if ( Key_GetCatcher( ) & KEYCATCH_MESSAGE ) {
			Message_Key( key );

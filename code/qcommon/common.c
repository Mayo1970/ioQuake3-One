...
#ifdef IOQ3_UWP
	// Xbox account defaults — exec last so q3config.cfg cannot override the name.
	Cbuf_ExecuteText(EXEC_NOW, "exec uwp_defaults.cfg\n");
	Cbuf_Execute();
#endif
}
